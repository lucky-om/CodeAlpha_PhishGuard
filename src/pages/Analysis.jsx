...
export default function Analysis() {
  ...
  const runSimulation = async (targetUrl) => {
    ...
    const steps = [
      ...
      { msg: "Initializing Lucky's Secure Sandboxed Inspection Engine v2.0.0...", type: 'sys' },
  ...
  const handleCopy = () => {
    ...
    const text = [
      ...
      '',
      `Generated by PhishGuard v2.0.0 | phishguard.luckyverse.tech`,
    ].join('\n');
    ...
    >
      ...
      <div className="text-center space-y-4">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-cyan-500/10 border border-cyan-500/20 text-cyan-500 text-xs font-mono font-bold uppercase">
          <Zap className="w-3 h-3" /> Lucky's Threat Intelligence Lab v2.0.0
        </div>
              ...
              {!report && !isAnalyzing ? (
                ...
                >
                  ...
                  <div className={`p-6 border-b flex items-center justify-between ${
                    report.riskLevel === 'High' ? 'bg-rose-500/10 text-rose-500 border-rose-500/20' :
                        ...
                        {report.flags.map((flag, idx) => (
                          <li key={idx} className="flex gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm hover:border-cyan-500/30 transition-all">
                            ...
                            <p className={`font-bold text-sm leading-tight ${
                              flag.type === 'critical' ? 'text-rose-600 dark:text-rose-400' :
