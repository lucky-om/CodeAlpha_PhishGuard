...
export default function Analysis() {
  ...
  const runSimulation = async (targetUrl) => {
    ...
    const steps = [
      ...
      { msg: "Initializing Lucky's Secure Sandboxed Inspection Engine v2.0.2...", type: 'sys' },
  ...
  const handleCopy = () => {
    ...
    const text = [
      ...
      '',
      `Generated by PhishGuard v2.0.2 | phishguard.luckyverse.tech`,
    ].join('\n');
    ...
    >
      ...
      <div className="text-center space-y-4">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-cyan-500/10 border border-cyan-500/20 text-cyan-500 text-xs font-mono font-bold uppercase">
          <Zap className="w-3 h-3" /> Lucky's Threat Intelligence Lab v2.0.2
        </div>
