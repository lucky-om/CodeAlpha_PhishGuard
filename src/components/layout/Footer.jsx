...
// Official Brand SVGs (inline — no import needed)
    ...
    <footer className="bg-white dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          {/* Column 2: Defensive Tools */}
          <div>
            <h4 className="text-xs font-black uppercase tracking-[0.3em] text-cyan-500 mb-6 font-mono italic underline decoration-slate-800 underline-offset-8">Defensive Tools</h4>
          ...
          {/* Column 3: Resources */}
          <div>
            <h4 className="text-xs font-black uppercase tracking-[0.3em] text-slate-400 dark:text-slate-600 mb-6 font-mono italic underline decoration-slate-800 underline-offset-8">Information</h4>
            <ul className="space-y-4">
              {[
          ...
          <div>
            <h4 className="text-xs font-black uppercase tracking-[0.3em] text-slate-400 dark:text-slate-600 mb-6 font-mono italic underline decoration-slate-800 underline-offset-8">Integrity</h4>
            <div className="p-6 rounded-3xl bg-slate-100 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 space-y-5">
              ...
              <a
                href="mailto:lucky@luckyverse.tech"
